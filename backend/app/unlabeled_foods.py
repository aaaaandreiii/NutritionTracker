...
CATALOG: tuple[CatalogFood, ...] = (
    ...
    CatalogFood(
        food_id="ph_gulay_side",
        display_name="Vegetable side / gulay",
        aliases=("gulay", "vegetable side", "vegetables", "pinakbet", "okra", "talong", "cabbage", "ampalaya"),
        portion_labels=("small side", "regular side", "user-described portion"),
        qualitative_tags=("companion food", "vegetable side", "fiber source", "minimally processed component", "recipe varies"),
        limitations=("Generic companion concept; no authoritative nutrient amounts are attached.",),
    ),
    CatalogFood(
        food_id="ph_ginisang_monggo",
        display_name="Ginisang monggo",
        aliases=("monggo", "mung beans", "ginisang monggo", "beans", "legumes"),
        portion_labels=("small bowl", "regular bowl", "user-described portion"),
        qualitative_tags=("companion food", "legume", "fiber source", "protein context", "recipe varies"),
        limitations=("Recipe, pork, shrimp, oil, and vegetable additions vary by preparation.",),
    ),
    CatalogFood(
        food_id="ph_boiled_egg",
        display_name="Boiled egg",
        aliases=("boiled egg", "egg", "itlog", "hard boiled egg"),
        portion_labels=("1 egg", "2 eggs", "user-described portion"),
        qualitative_tags=("companion food", "protein context", "minimally processed component"),
        limitations=("Preparation and serving size can vary; this qualitative record does not attach nutrient amounts.",),
    ),
    CatalogFood(
        food_id="ph_tokwa",
        display_name="Tokwa / tofu",
        aliases=("tokwa", "tofu", "soybean curd"),
        portion_labels=("small serving", "regular serving", "user-described portion"),
        qualitative_tags=("companion food", "protein context", "soy context", "recipe varies"),
        limitations=("Fried, sauced, or plain preparation changes context.",),
    ),
    CatalogFood(
        food_id="ph_grilled_fish",
        display_name="Grilled fish",
        aliases=("grilled fish", "isda", "inihaw na isda", "fish"),
        portion_labels=("small serving", "regular serving", "user-described portion"),
        qualitative_tags=("companion food", "protein context", "minimally processed component", "preparation varies"),
        limitations=("Fish type, sauce, and portion size vary; this qualitative record does not attach nutrient amounts.",),
    ),
    CatalogFood(
        food_id="ph_plain_yogurt",
        display_name="Plain unsweetened yogurt",
        aliases=("plain yogurt", "unsweetened yogurt", "yogurt"),
        portion_labels=("small cup", "regular cup", "user-described portion"),
        qualitative_tags=("companion food", "protein context", "unsweetened option"),
        limitations=("Use the package label for brand-specific nutrients and added sugar.",),
    ),
    CatalogFood(
        food_id="ph_unsweetened_peanut_butter",
        display_name="Unsweetened peanut butter",
        aliases=("peanut butter", "unsweetened peanut butter", "mani spread"),
        portion_labels=("thin spread", "1 tablespoon", "user-described portion"),
        qualitative_tags=("companion food", "fat context", "protein context", "nut or seed context"),
        limitations=("Brand labels vary; this qualitative record does not attach nutrient amounts.",),
    ),
    CatalogFood(
        food_id="ph_chia_ground_flax",
        display_name="Chia or ground flax",
        aliases=("chia", "chia seeds", "ground flax", "flaxseed", "flax seeds"),
        portion_labels=("small topping", "1 tablespoon", "user-described portion"),
        qualitative_tags=("companion food", "fiber source", "nut or seed context"),
        limitations=("Use a specific package label when numeric nutrient values matter.",),
    ),
)
